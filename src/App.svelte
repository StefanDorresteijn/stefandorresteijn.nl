  ...
  <div class="md:grid md:grid-cols-12 md:gap-8">
    <div class="md:max-w-2xl md:mx-auto md:col-span-6">
      ...
      <div class="mt-5">
        ...
        <div>
          <p class="text-gray-500 text-sm">Developer & Security Analyst</p>
          <p class="text-gray-900 text-lg">EYE Security</p>
        </div>
      </div>
      <a href="https://calendly.com/stefand" target="_blank" type="button" class="mt-5 inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
        Let's Talk!
      </a>
    </div>
...
<div class="md:w-10/12 bg-red-50 rounded-3xl mt-6 md:mt-16 md:grid md:grid-cols-12 md:gap-8">
  <div class="hidden md:inline-block justify-center relative sm:max-w-lg sm:mx-auto md:mt-0 md:max-w-none md:mx-0 md:col-span-6 md:flex md:items-center">
...
<!-- CYBER -->
<div class="md:float-right md:w-10/12 bg-blue-50 rounded-3xl mt-6 md:mt-16 md:grid md:grid-cols-12 md:gap-8">
  <div class="justify-center md:max-w-2xl md:mx-auto md:col-span-6 flex flex-wrap content-center">
    <div class="p-16">
...
<div class="mt-24 text-center mb-16">
  <h3 class="text-xl text-gray-900 font-semibold sm:text-2xl xl:text-3xl mb-3">Stay in touch!</h3>
  <span class="text-gray-600 text-lg block">Den Haag, Netherlands</span>
  <span class="text-gray-900 text-2xl font-semibold block">info@stefandorresteijn.nl</span>
</div>
<div class="text-center mb-16">
  <a href="https://twitter.com/stefanjd" target="_blank" class="bg-blue-50 inline-block rounded-full p-8">
